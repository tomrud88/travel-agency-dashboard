...
import { comboBoxItems, selectItems, travelStyles, user } from "~/constants";
...
export const loader = async () => {
    try {
        ...
        if (!Array.isArray(data)) {
            ...
            // If it's an object with a countries property, try that
            if (data && typeof data === 'object' && Array.isArray(data.countries)) {
                console.log("Found countries array in data.countries");
            ...
            // If it's an object with country data as values, convert to array
            if (data && typeof data === 'object') {
                console.log("Converting object to array");
                const countries = Object.values(data);
                if (Array.isArray(countries)) {
                    return countries.map((country: any) => ({
                        name: country.name || country.common || 'Unknown',
                        value: country.name || country.common || 'Unknown'
                    }));
                }
            }
        ...
        try {
            const response = await fetch('/api/create-trip', {
                ...
                body: JSON.stringify({
                    ...
                    numbersOfDays: formData.duration,
